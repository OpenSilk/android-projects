...
public class BundleHelper {
    ...
    public static final String TAG_ARG = "tagarg";
    ...
    public static String getTag(Bundle b) {
        return b.getString(TAG_ARG);
    }
    ...
    /**
     * Wraps org.opensilk.music.data.bundle for chaining.
     */
