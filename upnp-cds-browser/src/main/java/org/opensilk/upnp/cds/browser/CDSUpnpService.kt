...
//            Logger.getLogger("org.fourthline.cling.transport.spi.SOAPActionProcessor").setLevel(Level.FINER);
    ...
    private fun createUpnpService(): UpnpService {
        return object : UpnpServiceImpl(createConfiguration(), createRegistryListener()) {
    ...
    private fun createRegistryListener(): RegistryListener {
        return object : DefaultRegistryListener() {
            ...
            override fun remoteDeviceRemoved(registry: Registry, device: RemoteDevice) {
                notifyUri(device.identity.udn.identifierString)
            }

            fun notifyUri(deviceId: String) {
                //TODO
            }
        }
    }
