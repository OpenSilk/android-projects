...
public class MediaMetadataHelper {
    ...
    public static String getTitle(MediaMetadata meta) {
    ...
    public static String getSubTitle(MediaMetadata meta) {
        String name = meta.getString(METADATA_KEY_DISPLAY_SUBTITLE);
        return name;
    }
