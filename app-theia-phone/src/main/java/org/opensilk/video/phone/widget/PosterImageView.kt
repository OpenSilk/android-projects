 ...
 */
class PosterImageView(context: Context, attrs: AttributeSet) : ImageView(context, attrs) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val calculatedHeight = (widthSize.toFloat() * 1.47f).toInt()
        if (calculatedHeight > widthSize) {
            widthSize = (heightSize.toFloat() / 1.47f).toInt()
        } else {
