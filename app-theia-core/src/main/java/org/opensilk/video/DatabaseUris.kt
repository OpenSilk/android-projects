...
@Inject constructor(
    ...
    init {
        matcher.addURI(mAuthority, "videos/tv/series", DatabaseMatches.TV_SERIES)
        matcher.addURI(mAuthority, "videos/tv/series/#", DatabaseMatches.TV_SERIES_ONE)
        matcher.addURI(mAuthority, "videos/tv/series/#/episodes", DatabaseMatches.TV_SERIES_ONE_EPISODES)
        matcher.addURI(mAuthority, "videos/tv/series/search", DatabaseMatches.TV_SERIES_SEARCH)
        matcher.addURI(mAuthority, "videos/tv/episodes", DatabaseMatches.TV_EPISODES)
        matcher.addURI(mAuthority, "videos/tv/episodes/#", DatabaseMatches.TV_EPISODES_ONE)
        matcher.addURI(mAuthority, "videos/tv/banners", DatabaseMatches.TV_BANNERS)
        matcher.addURI(mAuthority, "videos/tv/banners/#", DatabaseMatches.TV_BANNERS_ONE)
        matcher.addURI(mAuthority, "videos/tv/actors", DatabaseMatches.TV_ACTORS)
        matcher.addURI(mAuthority, "videos/tv/actors/#", DatabaseMatches.TV_ACTORS_ONE)
        matcher.addURI(mAuthority, "videos/tv/lookups", DatabaseMatches.TV_LOOKUPS)
        matcher.addURI(mAuthority, "videos/tv/episodes/descriptions", DatabaseMatches.TV_EPISODE_DESC)
        matcher.addURI(mAuthority, "videos/tv/episodes/descriptions/#", DatabaseMatches.TV_EPISODE_DESC_ONE)

        matcher.addURI(mAuthority, "videos/media", DatabaseMatches.MEDIA)
        matcher.addURI(mAuthority, "videos/media/#", DatabaseMatches.MEDIA_ONE)

        matcher.addURI(mAuthority, "videos/movies", DatabaseMatches.MOVIES)
        matcher.addURI(mAuthority, "videos/movies/#", DatabaseMatches.MOVIES_ONE)
        matcher.addURI(mAuthority, "videos/movies/images", DatabaseMatches.MOVIE_IMAGES)
        matcher.addURI(mAuthority, "videos/movies/images/#", DatabaseMatches.MOVIE_IMAGES_ONE)
        matcher.addURI(mAuthority, "videos/movies/lookups", DatabaseMatches.MOVIE_LOOKUPS)
        matcher.addURI(mAuthority, "videos/movies/search", DatabaseMatches.MOVIE_SEARCH)
    }
