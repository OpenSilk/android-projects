...
public class PlaybackOverlayFragment extends DetailsFragment {
    ...
    private boolean mResetControlsToPrimaryActionsPending = true;
    ...
    private void resetControlsToPrimaryActions(ItemBridgeAdapter.ViewHolder vh) {
        if (DEBUG) Log.v(TAG, "resetControlsToPrimaryActions");
        if (vh == null && getVerticalGridView() != null) {
            vh = (ItemBridgeAdapter.ViewHolder) getVerticalGridView().findViewHolderForAdapterPosition(0);
        }
        if (vh == null) {
    ...
    protected boolean areControlsHidden() {
...
//            fade(true);
        ...
        AnimatorUpdateListener listener = new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator arg0) {
                ...
                ItemBridgeAdapter.ViewHolder adapterVh = (ItemBridgeAdapter.ViewHolder)
                        getVerticalGridView().findViewHolderForAdapterPosition(0);
    ...
    private final ItemBridgeAdapter.AdapterListener mAdapterListener =
        ...
        public void onAttachedToWindow(ItemBridgeAdapter.ViewHolder vh) {
            ...
            if (vh.getAdapterPosition() == 0 && mResetControlsToPrimaryActionsPending) {
