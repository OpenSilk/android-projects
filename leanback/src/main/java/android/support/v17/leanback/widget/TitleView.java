...
public class TitleView extends FrameLayout {
    ...
    private SearchOrbView mSearchOrbView0;
    ...
    public TitleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSearchOrbView0 = (SearchOrbView) rootView.findViewById(R.id.title_orb0);
        mSearchOrbView = (SearchOrbView) rootView.findViewById(R.id.title_orb);
        mSearchOrbView2 = (SearchOrbView) rootView.findViewById(R.id.title_orb2);
        mSearchOrbView3 = (SearchOrbView) rootView.findViewById(R.id.title_orb3);
    ...
    public void setOnAction0ClickedListener(View.OnClickListener listener) {
        mSearchOrbView0.setOnOrbClickedListener(listener);
    }

    public void setAction0AffordanceColors(SearchOrbView.Colors colors) {
        mSearchOrbView0.setOrbColors(colors);
    }

    public void setAction0Drawable(Drawable drawable) {
        mSearchOrbView0.setOrbIcon(drawable);
    }

    public SearchOrbView getAction0View() {
        return mSearchOrbView0;
    }

    public void setOnAction1ClickedListener(View.OnClickListener listener) {
        mSearchOrbView2.setOnOrbClickedListener(listener);
    }

    public void setAction1AffordanceColors(SearchOrbView.Colors colors) {
        mSearchOrbView2.setOrbColors(colors);
    }

    public void setAction1Drawable(Drawable drawable) {
        mSearchOrbView2.setOrbIcon(drawable);
    }

    public SearchOrbView getAction1View() {
        return mSearchOrbView2;
    }

    public void setOnAction2ClickedListener(View.OnClickListener listener) {
        mSearchOrbView3.setOnOrbClickedListener(listener);
    }

    public void setAction2AffordanceColors(SearchOrbView.Colors colors) {
        mSearchOrbView3.setOrbColors(colors);
    }

    public void setAction2Drawable(Drawable drawable) {
        mSearchOrbView3.setOrbIcon(drawable);
    }

    public SearchOrbView getAction2View() {
        return mSearchOrbView3;
    }
